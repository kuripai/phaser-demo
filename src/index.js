...
function create() {
    ...
    var s = this.add.tileSprite(0, 0, 800, 600, 'starfield');
    ...
    paddle = this.add.sprite(this.world.centerX, 500, 'breakout', 'paddle_big.png');
    ...
    scoreText = this.add.text(32, 550, 'score: 0', { font: "20px Arial", fill: "#ffffff", align: "left" });
    livesText = this.add.text(680, 550, 'lives: 3', { font: "20px Arial", fill: "#ffffff", align: "left" });
